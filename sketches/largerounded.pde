...
void sketchyCircle(int x1, int y1){
  ...
  vertex(x1,y1);
  //bezierVertex(80, 0, 80, 75, 30, 75);
  bezierVertex(WINDOWSIZE-w, WINDOWSIZE-w, WINDOWSIZE-w, WINDOWSIZE-w, v, WINDOWSIZE-v);
  endShape();
  
  beginShape();
  vertex(x1,y1);
  //bezierVertex(80, 0, 80, 75, 30, 75);
  bezierVertex(w, w, w, w, WINDOWSIZE-v, v);
  endShape();
  beginShape();
  vertex(x1,y1);
  //bezierVertex(80, 0, 80, 75, 30, 75);
  bezierVertex(WINDOWSIZE-w, WINDOWSIZE-w, WINDOWSIZE-w, WINDOWSIZE-w, v, v);
  endShape();
  
  beginShape();
  vertex(x1,y1);
  //bezierVertex(80, 0, 80, 75, 30, 75);
  bezierVertex(w, w, w, w, WINDOWSIZE-v, WINDOWSIZE-v);
  endShape();
}
